...
export const getPathsOfMdFiles = (userPath, mdFiles = []) => {
  ...
  if (mdFiles.length === 0) console.log('There are not .md files in this path');
  return mdFiles;
};
 ...
 */
export const getFileLinks = (userPath) => new Promise((resolve, reject) => {
 ...
 */
export const validateLink = (mdLink) => new Promise((resolve, reject) => {
