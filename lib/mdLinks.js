import {passedPath, checkIfPathExists, getAbsolutePath, getPathsOfMdFiles , getFileLinks} from './resources.js'
...
const mdLinks = (userPath, validate = false) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    } else if (pathExists && validate === true) {
